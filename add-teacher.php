...
<header>
  ...
  td{
    ...
    <div>
  <div class="title" style="color:; margin-bottom: 20px; margin-top: 25px; text-align: center;line-height: 1.5; font-family: 'Merriweather' arial;"><h1> Викладачі </h1></div>
  <table style="width: 100%;">
    <tr>
      <th>ID</th>
      <th>Викладачі</th>
       
       <th><a href="teach.php" style="float: right; " type="button" style="color: white" class="btn btn-primary">Добавити</a></th>
        <th><a href="main_admin.php" style="float: right; " type="button" style="color: white" class="btn btn-primary">Назад</a></th>
    </tr>
    <?php
    $teachers = mysqli_query($conn, "Select id, teacher FROM teachers");
    ...
    foreach ($teachers as $teach) {
      ?>
       <tr>
         <td><?=$teach[0]?></td>
         <td><?=$teach[1]?></td>
         <td><a href="update-teacher.php?id=<?=$teach[0]?>">Редагувати</a></td>
         <td><a style="color: red" href="delete-teacher.php?id=<?=$teach[0]?>">Видалити</a></td>
      </tr>
    <?php
  }
    ?>
