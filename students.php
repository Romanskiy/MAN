...
<header>
  ...
  td{
    ...
    <div>
  <div class="title" style="color:; margin-bottom: 20px; margin-top: 25px; text-align: center;line-height: 1.5; font-family: 'Merriweather' arial;"><h1> Юні науковці </h1></div>
  <table style="width: 100%;">
    <tr>
      <th>ID</th>
      <th>Студент</th>
       
       <th><a href="add-students.php" style="float: right; " type="button" style="color: white" class="btn btn-primary">Добавити</a></th>
        <th><a href="main_admin.php" style="float: right; " type="button" style="color: white" class="btn btn-primary">Назад</a></th>
    </tr>
    <?php
    $students = mysqli_query($conn, "Select id, student FROM project");
    ...
    foreach ($students as $student) {
      ?>
       <tr>
         <td><?=$student[0]?></td>
         <td><?=$student[1]?></td>
         <td><a href="update-student.php?id=<?=$student[0]?>">Редагувати</a></td>
         <td><a style="color: red" href="delete-student.php?id=<?=$student[0]?>">Видалити</a></td>
      </tr>
    <?php
  }
    ?>
