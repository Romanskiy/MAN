...
<form action="check-login.php" method="POST" style="width: 55%; margin-top: 60px; padding-bottom: 40px; border-bottom: solid; border-bottom-color: darkblue; border-top: solid; border-top-color: darkblue; padding-top: 40px ">
  <div class="form-group">
    <label for="login">Login</label>
    <input name="login" type="login" class="form-control" id="login1">
    <small id="emailHelp" class="form-text text-muted">We'll never share your login and password with anyone else.</small>
  </div>
  <div class="form-group">
  <div class="form-group">
