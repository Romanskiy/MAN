...
<?php
$news_id = $_GET['id'];
$news1 = mysqli_query($conn, "SELECT * From news Where id = '$news_id'");
$news1 = mysqli_fetch_assoc($news1); 
?>


<form style="width: 600px; margin-top:20px;" action="update-new.php" method="POST" enctype="multipart/form-data" >
...
<div class="input-group mb-3">
 ...
 <a href="add-news.php" type="button" style="color: white" class="btn btn-primary">Назад</a>
</form>
